/* 
 *   Copyright (c) 2025 by Marco J. Staginski. All Rights Reserved.
 *   
 *   Based on hos_w32.h:
...
/*
Name
  hos_emscripten.h - HTML OS definitions for Emscripten
Function
...
Notes
  ...
  from any other file.
Modified
  11/22/2025 MJStaginski  - Creation
*/
...
#ifndef HOS_EMSCRIPTEN_H
#define HOS_EMSCRIPTEN_H
 ...
 *   emscripten, this just returns a plain pointer to the type.  
 */
#define OS_HUGEPTR(type) type *

/* 
 *   Allocate a huge (>64k) buffer.  On emscripten, we can use the normal
...
/*
 *   Increment a "huge" pointer by a given amount.  On emscripten, ordinary
...
/*
 *   Free a huge pointer.  On emscripten, we use the standard memory allocator.
 *   
