...
Notes
  ...
  guit3 fork of win32/mpegamp/mpegamp_w32.h.  Identical to the legacy Win32
  version except that CMpegAmpW32's constructor no longer takes an
  IDirectSound* / HWND: guit3's CTadsCompressedAudio streams through
  CTadsAudioDevice (miniaudio) instead of a DirectSound buffer, so those
  parameters are gone from the whole digitized-audio ctor chain.  See
  htmltads/imgui/migration.md section 3.7.  Keep the rest of this file in
  sync with win32/mpegamp/mpegamp_w32.h.
Modified
